...
class ShopOrdersService
{
	...
	public static function sendShippingConfirmation(array $data)
	{
		$shop_order = ShopOrders::find($data['id']);
		Mail::to($shop_order->main_email)->send(new ShippingConfirmation($shop_order));
