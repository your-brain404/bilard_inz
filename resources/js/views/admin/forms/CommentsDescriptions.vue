			...
			<v-card>
				...
				<v-form ref="form" v-model="valid" lazy-validation>
					<v-row>
						<v-col class="" cols="12">
							<div class="pa-5">
								<v-text-field color="primary"  v-model="currentObject.question" label="Tytuł sekcji komentarzy"></v-text-field>
								<v-text-field color="primary"  v-model="currentObject.show" label="Pokaż więcej komentarzy"></v-text-field>
								<v-text-field  color="primary" v-model="currentObject.hide" label="Zwiń komentarze"></v-text-field>
								<v-text-field  color="primary" v-model="currentObject.delete" label="Usuń"></v-text-field>
